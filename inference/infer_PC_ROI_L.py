#!/usr/bin/env python3
"""
Inference script for ROI-Loss Post-Contrast model with distribution metrics.
Uses the same architecture as vanilla, just trained with different loss.
"""
...
config = {
    ...
    "output_dir": "inference_results/PC_ROI_L",
    "img_size": 256,
    "num_inference_timesteps": 50,
    "use_mask_input": False,  # ROI-L doesn't use mask as input
