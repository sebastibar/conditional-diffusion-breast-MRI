...
### Full-Breast Synthesis (metrics computed on full image)

| Model         | MAE (↓)       | SSIM (↑)       | PSNR (↑)       | LPIPS (↓)      | FID (↓)  | FRD (↓)  |
|---------------|---------------|----------------|----------------|----------------|----------|----------|
| SUB_(Vanilla) | 0.054 ± 0.021 | 0.847 ± 0.061 | 25.63 ± 3.35  | 0.194 ± 0.037 | 69.75    | 28.99    |
| SUB-ROI_(L)   | 0.051 ± 0.027 | 0.862 ± 0.062 | 24.11 ± 2.75  | 0.197 ± 0.035 | 67.07    | 21.29    |

---

### Full-Breast Synthesis (metrics computed on ROI)

| Model         | MAE (↓)       | SSIM (↑)       | PSNR (↑)       | LPIPS (↓)      | FID (↓)  | FRD (↓)  |
|---------------|---------------|----------------|----------------|----------------|----------|----------|
| SUB_(Vanilla) | 0.303 ± 0.131 | 0.322 ± 0.207 | 15.32 ± 3.67  | 0.327 ± 0.067 | 93.81    | 29.44    |
| SUB-ROI_(L)   | 0.247 ± 0.107 | 0.370 ± 0.210 | 16.84 ± 3.42  | 0.265 ± 0.094 | 89.48    | 23.45    |

---

### Single-Breast Synthesis (metrics computed on full image)

| Model         | MAE (↓)       | SSIM (↑)       | PSNR (↑)       | LPIPS (↓)      | FID (↓)  | FRD (↓)  |
|---------------|---------------|----------------|----------------|----------------|----------|----------|
| SUB_(Vanilla) | 0.092 ± 0.036 | 0.715 ± 0.095 | 22.52 ± 2.80  | 0.266 ± 0.052 | 88.10    | 59.82    |
| SUB-ROI_(L)   | 0.105 ± 0.048 | 0.695 ± 0.099 | 21.89 ± 2.97  | 0.249 ± 0.052 | 80.47    | 43.55    |

---

### Single-Breast Synthesis (metrics computed on ROI)

| Model         | MAE (↓)       | SSIM (↑)       | PSNR (↑)       | LPIPS (↓)      | FID (↓)  | FRD (↓)  |
|---------------|---------------|----------------|----------------|----------------|----------|----------|
| SUB_(Vanilla) | 0.307 ± 0.161 | 0.256 ± 0.207 | 15.64 ± 3.95  | 0.461 ± 0.089 | 101.60   | 85.35    |
| SUB-ROI_(L)   | 0.266 ± 0.125 | 0.278 ± 0.156 | 16.53 ± 3.44  | 0.326 ± 0.101 | 100.46   | 43.55    |
